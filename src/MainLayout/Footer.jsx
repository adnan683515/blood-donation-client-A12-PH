                ...
                <div className="grid row-gap-10 mb-8 lg:grid-cols-6">
                    ...
                    <div className="md:max-w-md lg:col-span-2">
                        ...
                        <form className="flex flex-col mt-4 md:flex-row">
                            ...
                            <button
                                type="submit"
                                className="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white bg-[var(--primary-color)] transition duration-200 rounded shadow-md "
                            >
                                Subscribe
                            </button>
                        </form>
